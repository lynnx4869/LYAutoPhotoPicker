#
#  Be sure to run `pod spec lint LYAutoPhotoPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "LYAutoPhotoPicker"
  s.version      = "0.0.1"
  s.summary      = "A photo picker for iOS like mobile QQ."
  ...
  s.source       = { :git => "https://github.com/lynnx4869/LYAutoPhotoPicker.git", :tag => "#{s.version}" }
