...
#import <LYAutoUtil/LYAutoUtil_Consts.h>

@interface LYCameraUtilViewController () <TOCropViewControllerDelegate>
...
@implementation LYCameraUtilViewController
...
- (void)initCameraBtns {
    ...
    [closeBtn setImage:[UIImage imageNamed:@"ly_cross"] forState:UIControlStateNormal];
    ...
    [takePhotoBtn setImage:[UIImage imageNamed:@"ly_round"] forState:UIControlStateNormal];
    ...
    [flashChangeBtn setImage:[UIImage imageNamed:@"ly_flash-off"] forState:UIControlStateNormal];
    ...
    [cameraChangeBtn setImage:[UIImage imageNamed:@"ly_camera-front-on"] forState:UIControlStateNormal];
...
- (void)initDisplayImage {
    ...
    [cutBtn setImage:[UIImage imageNamed:@"ly_cut"] forState:UIControlStateNormal];
    ...
    [sureBtn setImage:[UIImage imageNamed:@"ly_sure"] forState:UIControlStateNormal];
...
- (void)changeFlash:(UIButton *)btn {
    if (_device.flashMode == AVCaptureFlashModeOn) {
        [btn setImage:[UIImage imageNamed:@"ly_flash-off"] forState:UIControlStateNormal];
        ...
        [btn setImage:[UIImage imageNamed:@"ly_flash"] forState:UIControlStateNormal];
