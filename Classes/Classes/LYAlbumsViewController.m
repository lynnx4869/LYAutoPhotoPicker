...
@interface LYAlbumsViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation LYAlbumsViewController
...
- (void)viewDidLoad {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"LYAlbumDisplayCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"LYAlbumDisplayCellId"];
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            LYPhotosViewController *pvc = [[LYPhotosViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LYAlbumDisplayCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LYAlbumDisplayCellId"];
