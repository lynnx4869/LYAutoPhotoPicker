...
#import <LYAutoUtil/UIColor+LYUtil.h>
#import <LYAutoUtil/LYAutoSwitchAlertView.h>
...
@interface LYPhotosViewController ()
    <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, TOCropViewControllerDelegate, LYImageCellTapDelegate, MWPhotoBrowserDelegate>
...
- (void)viewDidLoad {
    ...
    [_collectionView registerNib:[UINib nibWithNibName:@"LYPhotoSelectCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"LYPhotoSelectCellId"];
    ...
    [_cutBtn setTitleColor:[UIColor colorWithHex:0x1296db] forState:UIControlStateNormal];
    ...
    [_sureBtn setTitleColor:[UIColor colorWithHex:0x1296db] forState:UIControlStateNormal];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    LYPhotoSelectCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"LYPhotoSelectCellId" forIndexPath:indexPath];
